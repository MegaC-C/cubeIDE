...
/* USER CODE BEGIN PFP */
void processData(){
	for (uint8_t n = buffStartPoint; n < (ADC_BUF_LEN/2) + (buffStartPoint - 1); n += 2){
		adcMosfet[n/2] = adc_buf[n];
		adcVoltage[n/2] = adc_buf[n + 1];
	}
}
/* USER CODE END PFP */
